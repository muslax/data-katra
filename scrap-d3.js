...
// https://www.nomor.net/_kodepos.php?_i=kecamatan-kodepos&daerah=Provinsi&jobs=&perhal=1000&urut=9&asc=0010000&sby=000000&no1=2&prov=Aceh+%28NAD%29

options.forEach((o) => {
  const encoded = encodeURI(o);
  console.log(
    `https://www.nomor.net/_kodepos.php?_i=kecamatan-kodepos&daerah=Provinsi&jobs=&perhal=1000&urut=9&asc=0010000&sby=000000&no1=2&prov=${encoded}`,
  );
});

/* nama,kodepos,jmldesa,jmlpulau,kode,tiped2,d2,d1 */
...
var lines = [];document
  ...
  .forEach((tr) => {
    ...
    let n9 = tr.querySelector("td:nth-child(9)").textContent;
    lines.push(
