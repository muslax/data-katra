...
Folder `kbbi` berisi 26 file `sql` (a-z) merupakan hasil konversi dari data json yang terdapat di repositori github [kbbi-harvester-cdn](https://github.com/Naandalist/kbbi-harvester-cdn) pada folder `word-details`. Data ini cukup besar, terdiri lebih dari 112 ribu berkas dengan total lebih dari 100 MB. Skrip yang digunakan untuk konversi `json` ke `sql` adalah `kbbi2sql.js`.
